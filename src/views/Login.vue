<template>
     <div class="container">
        ...
        <section class="section-1">
            <!-- <h1 class="section1-h1">ArtFront</h1> -->
            <div class="box1">
                <div>
                    <h1 class="box1-h1">Login To Your Account</h1>
                </div>
                <div>
                    <form action="/login" method="POST">
                        <input type="email" name="email" id="email" placeholder="E-mail">
                        <input type="password" name="password" id="email" placeholder="Password">
                        <input type="submit" value=" Log In" class="box1-btn" onclick="validate()">
                    </form>
                </div>
